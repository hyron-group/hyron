...
import {HyronService, UnofficialService} from "./Service";
import {PluginsMeta} from "./Plugins";
import {AddonsMeta} from "./Addons";
...
export class ModuleManager {
     ...
     */
    enableAddons(addonsList: { [name: string]: string }): void;
     ...
     */
    enableGlobalAddons(addonsList: { [name: string]: string }): void;
     ...
     */
    enablePlugins(pluginsList: { [name: string]: string }): void;
     ...
     */
    enableServices(servicesList: { [name: string]: string }): void;
     ...
     */
    enableServices(servicesList: { [name: string]: HyronService | UnofficialService }): void;
     ...
     */
    startServer(callback: Function ): void;
